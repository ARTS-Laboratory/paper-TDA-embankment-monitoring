...
# --- Isolation Forest ---
iso = IsolationForest(contamination=0.015, random_state=0)
...
scatter = ax.scatter(abnormal_pts[:, 0], abnormal_pts[:, 1], abnormal_pts[:, 2],
                     c=labels_dbscan, cmap='tab20', s=4)
...
#%%
# --- Define Bounding Boxes (manually from Step 1) ---
bounding_boxes = [
    # (xmin, xmax, ymin, ymax)
    (488000, 488020, 3600800, 3600825),   # Example cavity 1
    (488030, 488050, 3600850, 3600870),   # Example cavity 2
]

# --- Filter Points Inside Any Box ---
final_points = []
...
print("Filtered cavity region saved to 'selected_clusters_filtered.las'")

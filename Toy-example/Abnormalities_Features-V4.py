...
# File loading
file_path = "C:/Users/golzardm/Documents/paper-TDA-embankment-monitoring/Toy-example/Data/Abnormalities_Features-V3.xlsx"
...
for i, feature_y in enumerate(features):
    ...
    for j, feature_x in enumerate(features):
        ...
        ax.set_xlabel(r'\textbf{' + feature_x + '}', fontsize=10)  #  LaTeX format
        ax.set_ylabel(r'\textbf{' + feature_y + '}', fontsize=10)  #  LaTeX format
...
for ax, feature in zip(axes, features):
    ax.scatter(df["Index"], df[feature], 
               ...
               facecolors='none', linewidth=1.2, marker='o', alpha=0.8)
    ax.set_xlabel(r'\textbf{Index}', fontsize=10)  # ✅ LaTeX format
    ax.set_ylabel(r'\textbf{' + feature + '}', fontsize=10)  # ✅ LaTeX format
    ax.tick_params(axis='both', which='major', labelsize=8)
